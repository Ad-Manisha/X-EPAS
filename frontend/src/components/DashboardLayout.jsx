      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full z-50 shadow-sm">
        ...
        <div className="h-16 px-6 border-b border-gray-200 flex items-center">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-bold text-gray-900">X-EPAS</h1>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-gray-100">
          <button className="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 text-gray-600 hover:bg-gray-50 hover:text-gray-900 w-full">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
